...
//Rare exceptions to indicate a bug in the _knightsandprincesses code (Eg, function that a subclass should have implemented)
...
/**
 The base class for KnightsAndPrincesses proxies.
 */
