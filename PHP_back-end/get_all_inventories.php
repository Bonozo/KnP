...
if(isset($_GET))
{
	...
	if(isset($uid))
	{
		...
		$query =   
		   "SELECT 
				'INV' AS 'CATEGORY', kits.INV_ID AS 'ID', kii.NAME,kii.DESCRIPTION, kii.REQ_GOLD,kii.TYPE,kii.STATUS,kits.TOTAL_UNIT
			FROM 
			...
			SELECT 
				...
				kcm.CRAFT_NAME AS 'NAME', kcm.CRAFT_DESCRIPTION AS 'DESCRIPTION', 'N/A' AS 'REQ_GOLD',
