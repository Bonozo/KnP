...
class PHPWebSocket
{
	...
	const WS_OP_OPEN = "OPN";
	const WS_OP_MESSAGE = "MSG";
	const WS_HASH_CODE = "S83HSGGH5J";
	...
	*/
	...
	function wsRemoveClient($clientID) {
		...
		unset($this->client_user_ids[$clientID]);
