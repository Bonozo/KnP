...
{	
	static public function sendCommentNotification( CTableWall $wall , $message )
	{
		...
		{
			CNotificationLibrary::add( 'profile.submit.wall.comment' , $my->id , $targetUser->id , JText::sprintf('PLG_WALLS_WALL_COMMENT_EMAIL_SUBJECT' , $my->getDisplayName() ) , '' , 'profile.wallcomment' , $params );
			return true;
		}
		return false;
	}
