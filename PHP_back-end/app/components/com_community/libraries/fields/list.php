...
class CFieldsList
{
	...
	public function getFieldHTML( $field , $required )
	{
		...
		$html	= '<select id="field'.$field->id.'" name="field' . $field->id . '[]" type="select-multiple" multiple="multiple" class="jomTips tipRight select'.$class.'" title="' . JText::_( $field->name ) . '::' . CStringHelper::escape( JText::_( $field->tips ) ) . '">';
