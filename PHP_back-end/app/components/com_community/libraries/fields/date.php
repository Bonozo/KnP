...
class CFieldsDate
{
	...
	{		
		...
		$html .= '<div class="' . $class . '" style="display: inline-block; width:100% " title="' . JText::_( $field->name ) . '::' . CStringHelper::escape( JText::_( $field->tips ) ). '">';
		
		// Individual field should not have a tooltip
		$class	= '';
		
		$html .= '<input type="text" size="3" maxlength="2" name="field' . $field->id . '[]" value="' . $day . '" class="inputbox validate-custom-date" /> ' . JText::_('COM_COMMUNITY_DAY_FORMAT');
