...
<div class="community-form">
	...
	<?php if( $isFacebookUser && $config->get( 'facebook_invite_friends' ) && $config->get('fbconnectkey') && $config->get( 'fbconnectsecret' ) ){ ?>
...
joms.jQuery(document).ready(function(){
	...
	<div class="facebook">
		<a href="javascript:void(0);" onclick="window.open('<?php echo CRoute::_( 'index.php?option=com_community&view=connect&task=inviteFrame')?>', 'invite','height=410,width=620');"><?php echo JText::_( 'COM_COMMUNITY_FBCONNECT_INVITE_FACEBOOK_FRIENDS' ); ?></a>
	</div>
