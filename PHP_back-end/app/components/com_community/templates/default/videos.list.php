...
<div class="video-item">
	<div class="video-item">
        ...
        <div class="album-actions small">
            ...
            <a class="album-action delete" title="<?php echo JText::_('COM_COMMUNITY_DELETE') ?>" href="javascript:void(0);" onclick="joms.videos.deleteVideo('<?php echo $video->getId();?>','<?php echo $redirectUrl;?>');"><span><?php echo JText::_('COM_COMMUNITY_DELETE') ?></span></a>
						<?php
