...
<tr>
	...
	<td class="cWindowFormVal">
		<?php echo CPrivacy::getHTML( 'permissions', '', COMMUNITY_PRIVACY_BUTTON_LARGE ); ?>
	</td>
</tr>
<?php } ?>
...
<tr>
	<td class="key"></td>
	<td class="value"><div class="hints"><?php if($videoUploadLimit > 0) { echo JText::sprintf('COM_COMMUNITY_VIDEOS_UPLOAD_LIMIT_STATUS', $videoUploaded, $videoUploadLimit );} ?></div></td>
</tr>
</table>
