...
<div id="cFrontpageWrapper">
	...
	<div class="cLayout clrfix">
		...
		<div class="cSidebar clrfix">
			 ...
			 */			 			
			?>
			<?php if($this->params->get('showonline')) { ?>
					...
					<div class="app-box-header">
						...
						<div class="app-box-menus">
							<div class="app-box-menu toggle">
								<a class="app-box-menu-icon" href="javascript: void(0)" onclick="joms.apps.toggle('#recent-activities');"><span class="app-box-menu-title"><?php echo JText::_('COM_COMMUNITY_VIDEOS_EXPAND');?></span></a>
							</div>
						</div>
					</div>
				</div>
