<li id="video-<?php echo $video->id; ?>" class="video-item jomTips tipFullWidth clrfix" title="<?php echo $this->escape( $video->getTitle() ). '::' . $this->escape( CStringHelper::truncate($video->description , VIDEO_TIPS_LENGTH )); ?>">
