...
?>	
	...
	<div class="profile-box">
		...
		<?php if( $isMine ): ?><a href="<?php echo CRoute::_('index.php?option=com_community&view=profile&task=uploadAvatar'); ?>"><?php endif; ?><img src="<?php echo $profile->largeAvatar; ?>" alt="<?php echo $this->escape( $user->getDisplayName() ); ?>" /><?php if( $isMine ): ?></a><?php endif; ?>
		</div>
		...
		<div class="profile-info">
			...
			<ul class="profile-details cResetList">
				...
				<li class="title"><?php echo JText::_('COM_COMMUNITY_VIDEOS_PROFILE_VIDEO'); ?></li>
				<li class="video"><a class="jsIcon1 icon-videos" onclick="joms.videos.playProfileVideo( <?php echo $profile->profilevideo; ?> , <?php echo $user->id; ?> )" href="javascript:void(0);"><?php echo JText::_('COM_COMMUNITY_VIDEOS_MY_PROFILE');?></a></li>
				<?php 	} ?>
                <?php } ?>
                
				<?php if($config->get('enablekarma')){ ?>
				<li class="title"><?php echo JText::_('COM_COMMUNITY_KARMA'); ?></li>
				<li><img src="<?php echo $karmaImgUrl; ?>" alt="" /></li>
				<?php } ?>
			
				<li class="title"><?php echo JText::_('COM_COMMUNITY_MEMBER_SINCE'); ?></li>
				<li><?php echo JHTML::_('date', $registerDate , JText::_('DATE_FORMAT_LC2')); ?></li>

				<li class="title"><?php echo JText::_('COM_COMMUNITY_LAST_LOGIN'); ?></li>
				<li><?php echo $lastLogin; ?></li>

				<li class="title"><?php echo JText::_('COM_COMMUNITY_PROFILE_VIEW'); ?></li>
				...
				<li class="title"><?php echo JText::_('COM_COMMUNITY_PROFILE_TYPE'); ?></li>
