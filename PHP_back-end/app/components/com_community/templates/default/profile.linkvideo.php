...
<div class="video-full">
	...
	<?php } else { ?>
		<div style="text-align: center;"><img src="<?php echo JURI::root(); ?>/components/com_community/assets/video_thumb.png" alt="<?php echo JText::_('COM_COMMUNITY_VIDEOS_PROFILE_VIDEO_NOT_EXIST'); ?>" title="<?php echo JText::_('COM_COMMUNITY_VIDEOS_PROFILE_VIDEO_NOT_EXIST'); ?>" /></div>
		...
		<div class="video-items">
			...
			<div class="video-item" id="<?php echo "video-" . $v->getId() ?>">
				<div class="video-item">
					...
					<div class="video-thumb" style="width: <?php echo $videoThumbWidth+4; ?>px; height:<?php echo $videoThumbHeight+4; ?>px;">
