...
<div class="cLayout clrfix">
	...
	<div id="community-group-action" class="app-box">
		...
		<div class="app-box-header">
			<h2 class="app-box-title"><?php echo JText::_('COM_COMMUNITY_GROUPS_OPTION'); ?></h2>
		</div>
	...
	<div id="community-group-action" class="app-box">
		<?php if( ($isMember && !$isBanned) || ((!$isMember && !$isBanned) && !$waitingApproval) || $isMine || $isAdmin || $isSuperAdmin ) { ?>
		<div class="app-box-header">
			<h2 class="app-box-title"><?php echo JText::_('COM_COMMUNITY_GROUPS_ADMIN_OPTION'); ?></h2>
		</div>
    	...
    	<?php if( ($isAdmin || $isSuperAdmin) && $config->get('createannouncement') ): ?>
        	<!-- Add Bulletin -->
            <li>
	...
	<div id="community-group-members" class="app-box">
		<div class="app-box-header">
			<h2 class="app-box-title"><?php echo JText::sprintf('COM_COMMUNITY_GROUPS_MEMBERS'); ?></h2>
		</div>
			...
			<div class="group-top">
				...
				<div class="group-main">
						...
						<div class="group-approval">
								...
								<div class="info">
										<span class="icon-waitingapproval"><?php echo JText::_('COM_COMMUNITY_GROUPS_APPROVAL_PENDING'); ?></span>
								</div>
								<?php }?>
						</div>
						<!-- Group Approval -->
						...
						<div id="community-group-info" class="group-info">
								...
								<!--<div class="cparam group-description">
										<div class="clabel"><?php echo JText::_('COM_COMMUNITY_GROUPS_TYPE');?>:</div>
								...
								<div class="cparam group-owner">
									<div class="clabel">
										<?php echo JText::_('COM_COMMUNITY_GROUP_LIKE');?>:
									</div>
									<div class="cdata">
				...
				<div class="group-desc">
						<h2><?php echo JText::_('COM_COMMUNITY_GROUPS_DESCRIPTION');?></h2>
	...
	<div id="community-group-news" class="app-box">
            ...
            <div class="app-box-footer">
            	<div class="app-box-info"><?php echo JText::sprintf( 'COM_COMMUNITY_GROUPS_BULLETIN_COUNT_OF' , count($bulletins) , $totalBulletin ); ?></div>
	...
	<?php endif; ?>
        ...
        <div id="community-group-dicussion" class="app-box">
            ...
            <div class="app-box-footer">
				<div class="app-box-info"><?php echo JText::sprintf( 'COM_COMMUNITY_GROUPS_DISCUSSION_COUNT_OF' , count($discussions) , $totalDiscussion ); ?></div>
                <div class="app-box-actions">
