	...
	<div class="app-widget-header">
		<div class="app-box-header">
			...
			<?php if( $isOwner && $app->hasConfig ){ ?>
    		  <a title="<?php echo JText::_('COM_COMMUNITY_EDIT');?>" href="javascript:void(0);" class="app-box-menu-icon" onclick="joms.apps.showSettingsWindow('<?php echo $app->id;?>','<?php echo $app->name;?>');"></a>
    		<?php } ?>
		</div>
	</div>
