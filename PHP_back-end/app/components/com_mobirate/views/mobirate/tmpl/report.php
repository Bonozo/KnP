...
JHTML::_('stylesheet', 'mobirate.css', 'components/com_mobirate/css/');
?>

<p><?php echo JText::_("COM_MOBIRATE_ABOUT_TO_REPORT_COMMENT") ?></p>

<form action="<?php echo JRoute::_("index.php?option=com_mobirate&task=reportconfirmed&id=".$this->item->id) ?>" method="post">
	...
	<input type="submit" value="<?php echo JText::_("COM_MOBIRATE_REPORT_COMMENT")?>" />
