...
class MyblogShowTask extends MyblogShowBase
{
	...
	function display($styleid = '', $wrapTag = 'div')
	{
		...
		if (!$tpl->is_cached())
		{
			...
			$row->editLink = '<span class="editLink" onclick="myAzrulShowWindow(\'index.php?option=com_myblog&tmpl=component&task=write&no_html=1&id='.$row->id.'\');">&nbsp;[' . JText::_('Edit') . ']&nbsp;</span>';
