...
<?php foreach($this->items as $i => $item): ?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td>
			<a href="mailto:<?php echo $item->email?>" title="Contact <?php echo $this->escape($item->email)?>">
				<?php echo $this->escape($item->email); ?>
			</a>
		</td>
		<td>
			<a href="<?php echo $this->escape($item->url)?>" title="Goto <?php echo $this->escape($item->url)?>" target="_blank">
