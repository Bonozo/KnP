...
class MobirateViewAbout extends JView 
{
	protected $data;
    ...
    {
		$this->data = JApplicationHelper::parseXMLInstallFile( JPATH_COMPONENT_ADMINISTRATOR . DS . 'mobirate.xml');
	...
	{
		JToolBarHelper::title(JText::_('COM_MOBIRATE_TITLE_ABOUT'), 'mobirate');
	}
}
