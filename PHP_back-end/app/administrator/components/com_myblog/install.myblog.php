...
class Myblog_installer{
	...
	*/
	function run(){
		...
		echo '<p><img src="'.rtrim( JURI::root() , '/').'/components/com_myblog/images/pageicon.png" alt="logo" /></p>';
...
class Myblog_installer_15 extends Myblog_installer{
	...
	function saveAdminIcon(){
		...
		$q = "UPDATE #__components 
				SET admin_menu_img='../administrator/components/com_myblog/images/myblog-icon.png' 
...
class Myblog_installer_16 extends Myblog_installer{
	...
	function saveAdminIcon(){
		echo '<img src="'.JURI::base().'components/com_myblog/images/save_tag.gif"> Creating database tables<br/>';
	}
	...
	function checkAzrulVideoBot(){
		...
		echo '<img src="'.JURI::base().'components/com_myblog/images/save_tag.gif"> Installing Azrul Videobot<br />';
	...
	function checkAzrulSystemMambot(){
		...
		//if($botVersion == 0)
		{
			echo '<img src="'.JURI::base().'components/com_myblog/images/save_tag.gif"> Installing Azrul.com System mambots <br/>';
	...
	*/
	function prepareDefaultSection(){
		...
		if ($sectionid)
		{
			echo '<img src="'.JURI::base().'components/com_myblog/images/save_tag.gif"> Previous MyBlog section found. Republishing section.<br/>';
		...
		else
		{
			...
			echo '<img src="'.JURI::base().'components/com_myblog/images/save_tag.gif"> Creating MyBlog section. <br/>';
