...
<table cellspacing="0" class="admintable" border="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<td>:</td>
			<td>
				<span><?php echo $this->_buildRadio($row->published, 'published', array( JText::_('COM_COMMUNITY_YES_OPTION'), JText::_('COM_COMMUNITY_NO_OPTION')));?></span>
			</td>
		</tr>
		<tr>
			<td class="key"><?php echo JText::_('COM_COMMUNITY_VISIBLE');?></td>
			<td>:</td>
			<td><?php echo $this->_buildRadio($row->visible, 'visible', array( JText::_('COM_COMMUNITY_YES_OPTION'), JText::_('COM_COMMUNITY_NO_OPTION')));?></td>
		</tr>
	</tbody>
</table>
</form>
...
<?php
	...
	public function _buildSize(&$row)
	{
		...
		$html	.= '<td class="key">' . JText::_('COM_COMMUNITY_MINIMUM_CHARACTERS') . '</td>'
				 . '<td>:</td>'
				 . '<td>'
				 . '	<input type="text" name="min" size="5" value="' . $row->min . '" />'
				 . '</td>'
				 . '<td class="key">' . JText::_('COM_COMMUNITY_MAXIMUM_CHARACTERS') . '</td>'
				 . '<td>:</td>'
				 . '<td>'
