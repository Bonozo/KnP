...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td class="key">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_GROUPS_DISCUSSION_ORDERING' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_GROUPS_DISCUSSION_ORDERING_TIPS'); ?>">
						<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_GROUPS_DISCUSSION_ORDERING' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo $this->lists['groupDicussOrder']; ?>
				</td>
			</tr>
			<tr>
				<td class="key">
