...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_PHOTOS_FLASH_UPLOADER' ); ?>::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_PHOTOS_FLASH_UPLOADER_TIPS'); ?>">
						<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_PHOTOS_FLASH_UPLOADER' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'flashuploader' , null ,  $this->config->get('flashuploader') , JText::_('COM_COMMUNITY_YES_OPTION') , JText::_('COM_COMMUNITY_NO_OPTION') ); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
