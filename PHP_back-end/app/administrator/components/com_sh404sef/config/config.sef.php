...
// 3.1.5.1098
// saved at: 2012-01-27 06:02:14
// by: mamunnu (id: 44 )
// domain: http://bonozo.com
...
$defaultComponentStringList = array("acepolls"=>"","acymailing"=>"","community"=>"","banners"=>"","contact"=>"","content"=>"","gantry"=>"","kunena"=>"","login"=>"","mailto"=>"","newsfeeds"=>"","search"=>"","weblinks"=>"","wrapper"=>"","jce"=>"","k2"=>"","myblog"=>"","rokcandy"=>"","rokmodule"=>"","rsform"=>"");
