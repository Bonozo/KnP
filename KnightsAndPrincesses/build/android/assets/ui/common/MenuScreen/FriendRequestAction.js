function FriendRequestAction(userinfo, friend_uid) {
	...
	var bg_image;
	var content_loads = 0;
	var freind_info = "http://bonozo.com:8080/knp/get_avatar_info.php?uid=" + friend_uid.UID;
    ...
    accept_req.addEventListener('click', function(e) {
        //actInd.show();
        var _url = "http://bonozo.com:8080/knp/friendship_notifications_action.php?uid=" + friend_uid.UID + "&friend_uid=" + userinfo.Record[0].UID + "&action=FRIENDS";
        var items_json = "";
        var items_length = 0;
        var httpclientt = require('/ui/common/Functions/function');
        httpclientt.requestServer({
    ...
    decline_req.addEventListener('click', function(e) {
        ...
        //message will only shows in android.
        //actInd.show();
        var _url = "http://bonozo.com:8080/knp/friendship_notifications_action.php?uid=" + friend_uid.UID + "&friend_uid=" + userinfo.Record[0].UID + "&action=DENIED";
        //&="+friendJson.UID+"";
        var items_json = "";
        var items_length = 0;
        var httpclientt = require('/ui/common/Functions/function');
			...
			ConfirmationAlert.addEventListener('click', function(e) {
				...
				switch (e.index) {
					case 0:
						...
						var assign_quest_url = "http://bonozo.com:8080/knp/knp_assign_quests.php?assign_by_uid=" + userinfo.Record[0].UID + "&assign_to_uid=" + friend_uid.UID  + "&quest_ids=" + quest_ids + "&message=" + Ti.Network.encodeURIComponent(name_text.value) + "&num_of_hours=" + num_of_hours + "&status=INCOMPLETE&user_id=" + user_id + "";
						var httpclientt = require('/ui/common/Functions/function');
						httpclientt.requestServer({
							success : function(e) {
								items_json = JSON.parse(this.responseText);
