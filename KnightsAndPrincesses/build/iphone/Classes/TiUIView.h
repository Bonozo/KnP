...
/**
 Base class for all KnightsAndPrincesses views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the KnightsAndPrincesses view hierarchy (such as wrapped iOS UIViews) was touched.
