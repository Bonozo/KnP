...
// in simulator we redefine to format for KnightsAndPrincesses Developer console
...
{\
	NSString * exceptionName = [@"org.knightsandprincesses." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.knightsandprincesses";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIKnightsAndPrincessesNativeItemNone = -1, 
	UIKnightsAndPrincessesNativeItemSpinner = -2,
	UIKnightsAndPrincessesNativeItemProgressBar = -3,
	
	UIKnightsAndPrincessesNativeItemSlider = -4,
	UIKnightsAndPrincessesNativeItemSwitch = -5,
	UIKnightsAndPrincessesNativeItemMultiButton = -6,
	UIKnightsAndPrincessesNativeItemSegmented = -7,
	
	UIKnightsAndPrincessesNativeItemTextView = -8,
	UIKnightsAndPrincessesNativeItemTextField = -9,
	UIKnightsAndPrincessesNativeItemSearchBar = -10,
	
	UIKnightsAndPrincessesNativeItemPicker = -11,
	UIKnightsAndPrincessesNativeItemDatePicker = -12,
	
	UIKnightsAndPrincessesNativeItemInfoLight = -13,
	UIKnightsAndPrincessesNativeItemInfoDark = -14,
	
	UIKnightsAndPrincessesNativeItemDisclosure = -15,
	
	UIKnightsAndPrincessesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all KnightsAndPrincesses instances of
