...
@interface KnightsAndPrincessesObject : KrollCoverageObject {
#else
@interface KnightsAndPrincessesObject : KrollObject {
#endif
@private
...
extern NSString * KnightsAndPrincesses$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	KnightsAndPrincessesObject *_knightsandprincesses;
    KrollObject* console;
	BOOL shutdown;
