 ...
 * Copyright (c) 2009-2011 by KnightsAndPrincesses, Inc. All Rights Reserved.
...
//@interface KnightsAndPrincessesObject : NSObject
//@end

@interface KnightsAndPrincessesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KnightsAndPrincessesObject class]])
		{
			for (NSString *key in [[(KnightsAndPrincessesObject*)o modules] allKeys])
			{
