...
Storekit.receiptVerificationSharedSecret = "727785971";
...
if (!Storekit.canMakePayments)
	...
	/*
	 2) Tracking what the user has purchased in the past.
	 */
	var whatHaveIPurchased = Ti.UI.createButton({ color: '#761f56',
	...
	requestProduct('DigitalSodaPop', function (product) {
		var buySingleItem = Ti.UI.createButton({ color: '#761f56',
	...
	requestProduct('MonthlySodaPop', function (product) {
		var buySubscription = Ti.UI.createButton({ color: '#761f56',
			title:'Buy ' + product.title + ', ' + product.formattedPrice,
	...
	/*
	 5) Restoring past purchases.
	 */
	var restoreCompletedTransactions = Ti.UI.createButton({ color: '#761f56',
