...
var storeLbl = Ti.UI.createLabel({
	text : 'SELECT A FRIEND TO SEND GIFT',
	color : '#FFFFFF',
	font : {
		fontWeight : 'bold',
...
var confirm = Titanium.UI.createAlertDialog({
	title : 'Confirmation',
	message : 'Tap CONFIRM to send gift',
	buttonNames : ['Confirm', 'Cancel'],
	cancel : 1
});
function ConfirmAndSendGift(receiver_id){
	confirm.show(); 
	confirm.addEventListener('click', function(e) {
		Titanium.API.info('e = ' + JSON.stringify(e));
		var item_cat = Ti.App.Properties.getString('active_inventory_cat');
		var item_id = Ti.App.Properties.getString('active_inventory_id');
		...
		switch (e.index) {
			case 0:
				var gift_type = (item_cat == 'INV')?'INVENTORY':'CRAFT';
				var url = "http://justechinfo.com/kap_server/send_gift.php?sender_id=" + Ti.App.GLBL_uid + "&receiver_id="+receiver_id+
				"&gift_id="+item_id+"&gift_type="+gift_type;
