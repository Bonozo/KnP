function openNewBody(userinfojson, activeScreen) {
    var Body = require('ui/iphone/MenuScreen/' + activeScreen);
    ...
    function hideLoader() {
        ...
        if (images_counter >= 3) {
            ...
            if (userinfojson.Record[0].NAME == '') {
                var ResetClass = require('ui/iphone/MenuScreen/ResetClass');
 ...
 */   // service_intent.putExtra('uid', userinfojson.Record[0].UID);
    ...
    httpclientt.requestServer({
        success : function(e) {
            ...
            var ProgressBar = require('ui/iphone/menus/ProgressBar');
    ...
    var MenuIcons = require('ui/iphone/menus/MenuIcons');
