					...
					if(counter == '3'){
						//alert('you lost the game');
							if (!played) {
								...
								_url = "http://therealmattharmon.com/knp/knp_set_quest_status.php?game_status=LOSE&quest_status=" + quest_status + "&assign_quest_id=" + _assign_quest_id + "&quest_id=" + quest_id + "&uid=" + userinfo.Record[0].UID + "&friend_uid=" + userinfo.Record[0].UID + "";
								httpclientt.requestServer({
									success : function(e) {
										items_json = JSON.parse(this.responseText);
										if (items_json.Record != undefined) {
