	...
	signInButton.addEventListener('click', function(e) {
		if (emailField.value == "" && passwordField.value == "") {
			...
			httpclientt.requestServer({
				...
				method : 'GET',
				contentType : 'text/xml',
				url : "http://therealmattharmon.com/knp/?email=" + emailField.value + "&password=" + passwordField.value + "&version=0.3&device_token="
			});
		}
	});
	actInd.hide();
...
win.add(actInd);
    ...
    var emailField = Titanium.UI.createTextField({
        ...
        hintText : "Email",
        width : "75%",
        value :'',//'test5@email.com',///Ti.App.Properties.getString('knp_email'), //"robot1@email.com",
        left : "15%",
        top : "63%",
        borderRadius  : '5',
        backgroundColor : '#FFFFFF'
