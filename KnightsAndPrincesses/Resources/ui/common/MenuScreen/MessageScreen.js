function messages(Message_Thread,userinfo,coininfo){
	var Loggedin_id=userinfo.Record[0].UID;
	var self = Ti.UI.createWindow({ orientation:Ti.UI.PORTRAIT,navBarHidden:true	});
	...
	text_feild.addEventListener('return',function(e){
		...
		var httpclientt=require('/ui/common/Functions/function');
				httpclientt.requestServer({
											...
											url : "http://justechinfo.com/kap_server/send_message.php?sender_id="+Loggedin_id+"&receiver_id=10000008&message="+text_feild.value+"",
...
timer = setInterval(function(){
				...
				httpclientt.requestServer({
											...
											method : 'GET',
											contentType:'text/xml',
											url : "http://www.justechinfo.com/kap_server/get_unread_messages.php?sender_id=10000008+&receiver_id="+Loggedin_id+"",
