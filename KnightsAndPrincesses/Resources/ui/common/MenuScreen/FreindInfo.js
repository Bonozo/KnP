function freindinfo(userinfo,coininfo){
	...
	var bottom=new botombar(userinfo,coininfo);
	view.add(bottom);
	...
	messages_button.addEventListener('click',function(e){
			...
			httpclientt.requestServer({
											...
											if (Messages_Thread.Record != undefined) {
												...
												var status = require('/ui/common/MenuScreen/MessageScreen');
												var statusscreen = new status(Messages_Thread,userinfo,coininfo);
											...
											url : "http://justechinfo.com/kap_server/get_thread_messages.php?sender_id="+userinfo.Record[0].UID+"&receiver_id=10000008",
